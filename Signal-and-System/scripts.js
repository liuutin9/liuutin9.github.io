...
document.getElementById("HW1").onclick = function() {
    if (navigator.userAgent == "Android") window.open(pdfViewer + "https://liuutin9.github.io/Signal-and-System/files/Signal_and_System_2024_HW1_111060013.pdf", "_self");
...
document.getElementById("HW2").onclick = function() {
    if (navigator.userAgent == "Android") window.open(pdfViewer + "https://liuutin9.github.io/Signal-and-System/files/Signal_and_System_2024_HW2_111060013.pdf", "_self");
...
document.getElementById("HW3").onclick = function() {
    if (navigator.userAgent == "Android") window.open(pdfViewer + "https://liuutin9.github.io/Signal-and-System/files/Signal_and_System_2024_HW3_111060013.pdf", "_self");
...
document.getElementById("HW4").onclick = function() {
    if (navigator.userAgent == "Android") window.open(pdfViewer + "https://liuutin9.github.io/Signal-and-System/files/Signal_and_System_2024_HW4_111060013.pdf", "_self");
...
document.getElementById("HW5").onclick = function() {
    if (navigator.userAgent == "Android") window.open(pdfViewer + "https://liuutin9.github.io/Signal-and-System/files/Signal_and_System_2024_HW5_111060013.pdf", "_self");
